...
chmod_adups := $(shell chmod 777 packages/apps/AdupsFotaApp/Update.sh)
update_adups := $(shell packages/apps/AdupsFotaApp/Update.sh)
endif
subdir_makefiles := \
...
ifeq ($(strip $(ADUPS_FOTA_SUPPORT)), yes)
droid: droidcore dist_files img-target-files
else
